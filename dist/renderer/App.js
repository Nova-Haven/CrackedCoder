...
const App = () => {
    ...
    return (react_1.default.createElement("div", { className: "app" },
        ...
        showConfig && (react_1.default.createElement(ConfigScreen_1.default, { onSave: handleConfigSave, initialConfig: config
                ? {
        ...
        react_1.default.createElement("div", { className: "status-row" }, isProcessing ? (react_1.default.createElement("div", { className: "processing" },
            ...
            react_1.default.createElement("div", { className: "hint" }, "(Press \u2318/Ctrl + R to reset)"))) : (react_1.default.createElement("div", { className: "empty-status" }, screenshots.length > 0 ? (`Press ⌘/Ctrl + ↵ to process ${screenshots.length} screenshot${screenshots.length > 1 ? "s" : ""}`) : (react_1.default.createElement("div", { className: "compact-status" },
            react_1.default.createElement("span", null, "Take first screenshot"),
            react_1.default.createElement("code", null, "\u2318/Ctrl + H"))))))));
};
exports.default = App;
